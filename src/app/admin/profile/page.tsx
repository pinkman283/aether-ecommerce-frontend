    ...
    <div className="space-y-6 max-w-4xl mx-auto pb-16">
      ...
      <form onSubmit={handleMainFormSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-between pt-2">
          <div>
            {hasUnsavedChanges && (
              <span className="inline-flex items-center gap-2 text-xs text-amber-300 font-medium">
          ...
          <div className="flex items-center gap-3">
            {hasUnsavedChanges && (
              <button
                ...
                className="px-4 py-2.5 rounded-xl text-xs font-medium text-slate-300 hover:text-white hover:bg-white/[0.06] transition-colors cursor-pointer"
              >
                Discard
              </button>
            )}
