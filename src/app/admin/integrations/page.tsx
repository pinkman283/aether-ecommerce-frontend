    ...
    <div className="space-y-6 pb-12">
      ...
      {isModalOpen && activeIntegration && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4 overflow-y-auto">
          <div className="bg-[#0f121b] border border-white/10 rounded-2xl w-full max-w-xl p-6 shadow-2xl space-y-5 my-8">
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#161a26] border border-white/10 flex items-center justify-center text-amber-400">
            ...
            <form onSubmit={handleSaveModal} className="space-y-4">
              {/* Toggles */}
              <div className="grid grid-cols-2 gap-3 bg-[#161a26] p-3 rounded-xl border border-white/5">
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <input
                    ...
                    className="w-4 h-4 rounded text-amber-500 bg-[#090b10] border-white/20 focus:ring-amber-500"
                  />
                </label>
              ...
              <div className="space-y-3">
                ...
                {formData.credentials && Object.keys(formData.credentials).length > 0 ? (
                      ...
                      <div key={k} className="space-y-1">
                        <div className="flex items-center justify-between">
                          ...
                          {isSecret && (
                            ...
                            >
                              {isVisible ? <EyeOff className="w-3 h-3" /> : <Eye className="w-3 h-3 text-slate-400" />}
                  ...
                  <div className="p-3 bg-[#161a26] rounded-xl border border-white/5 text-xs text-slate-400">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/10">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold bg-white/5 hover:bg-white/10 text-slate-300 border border-white/10 transition-all cursor-pointer"
                >
