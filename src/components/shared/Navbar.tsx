              ...
              {isAuthenticated && user ? (
                <div>
                  <button
                    ...
                    className="flex items-center gap-2 pl-1.5 pr-3 py-1.5 rounded-xl border border-white/10 hover:border-indigo-500/40 bg-white/5 hover:bg-white/10 transition-all text-xs font-bold text-slate-200"
                  >
                    {user.avatar ? (
                      <img
                        src={user.avatar}
                      ...
                      <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-indigo-600/40 to-purple-600/40 text-indigo-200 ring-1 ring-indigo-400/40 flex items-center justify-center font-black text-xs">
