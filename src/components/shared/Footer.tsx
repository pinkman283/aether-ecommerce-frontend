...
export function Footer() {
  ...
  return (
    ...
    >
      ...
      {/* Main Footer Links */}
      <div className="theme-footer-main max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16 sm:pt-12 sm:pb-16 lg:pt-14 lg:pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          {/* Brand Col */}
          <div className="lg:col-span-2 space-y-1">
            <Link href="/" suppressHydrationWarning className="flex items-center inline-flex group select-none p-0">
