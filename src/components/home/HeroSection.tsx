...
const DEFAULT_SECONDARY_BANNERS: Banner[] = [
  ...
  {
    id: 994,
    title: "Special Studio Rewards On Your Orders",
    subtitle: "Unlock exclusive perks, early access, and direct discounts with our VIP rewards.",
    eyebrow: "CUSTOMER REWARDS",
    badge: "VIP PERKS",
    discount_tag: "EXCLUSIVE OFFERS",
